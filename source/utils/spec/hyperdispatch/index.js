...
class Router {
  ...
  add(name, handler) {
    switch (name) {
      ...
      case '@roombase/set-metadata':
        ...
        break
      case '@roombase/set-drive-key':
        this._handler6 = handler
        break
      case '@roombase/update-drive-metadata':
  ...
  _checkAll() {
    ...
    assert(this._handler6 !== null, 'Missing handler for "@roombase/set-drive-key"')
    assert(this._handler7 !== null, 'Missing handler for "@roombase/update-drive-metadata"')
  }
...
const route6 = {
  id: 6,
  enc: getEncoding('@roombase/drive-metadata')
}
