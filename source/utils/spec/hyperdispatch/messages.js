...
const encoding2 = {
  preencode(state, m) {
    ...
    if (version >= 2 && m.messageCount) c.int.preencode(state, m.messageCount)
  },
  encode(state, m) {
    const flags = (version >= 2 && m.messageCount) ? 1 : 0
    ...
    if (version >= 2 && m.messageCount) c.int.encode(state, m.messageCount)
  },
  decode(state) {
    ...
    return {
      ...
      name: r1,
      createdAt: r2,
      messageCount: (version >= 2 && (flags & 1) !== 0) ? c.int.decode(state) : 0
    }
  }
}
...
const encoding5 = {
  preencode(state, m) {
    ...
    if (version >= 3 && m.messageCount) c.int.preencode(state, m.messageCount)
  },
  encode(state, m) {
    const flags = (version >= 3 && m.messageCount) ? 1 : 0
    ...
    if (version >= 3 && m.messageCount) c.int.encode(state, m.messageCount)
  },
  decode(state) {
    const r0 = c.string.decode(state)
    const r1 = c.string.decode(state)
    ...
    return {
      ...
      name: r1,
      createdAt: r2,
      messageCount: (version >= 3 && (flags & 1) !== 0) ? c.int.decode(state) : 0
    }
  }
}
...
function getEncoding(name) {
  switch (name) {
    ...
    case '@roombase/metadata': return encoding5
